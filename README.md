...
English Speakers: This is my study summary of **Introduction to Machine Learning with Python** in Korean.

[Introduction to Machine Learning with Python](https://github.com/amueller/introduction_to_ml_with_python) 을 읽으면서 노트북으로 배운거 정리했습니다.
